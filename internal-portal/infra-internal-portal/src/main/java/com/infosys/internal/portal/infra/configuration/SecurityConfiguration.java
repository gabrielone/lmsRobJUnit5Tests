package com.infosys.internal.portal.infra.configuration;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	 ...
	 * authentic and manages login,logout,error like pages and also guides users to
	 * role-specific urls.
	 */
	@Override
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/user/list-claims/**").hasRole("EMPLOYEE").
